...
urlpatterns = [
    ...
    url(r"^infinite/(?P<depth>\d+)$",
        InfiniteLinksView.as_view(), name="infinite-links"),
    url(r"^pet-registration/(?P<pet_id>\w+)$",
        PetRegistrationView.as_view(), name="pet-registration"),
    ...
    url(r"^refsheet$",
        RedirectViewKeepMethod.as_view(
            url="https://www.furaffinity.net/view/26535937/", permanent=False),
        name="refsheet"),
    url(r"^ddnswolf$",
        RedirectViewKeepMethod.as_view(
